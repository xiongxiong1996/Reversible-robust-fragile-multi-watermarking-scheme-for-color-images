...
ylabel('NC');
legend('proposed method','Su et al.[5]','Duan et al[11]','Location','SouthWest');
% a = [1,2,3,4,5,6,7,8];
...
xlabel('Gaussian noise intensity');
ylabel('BER');
legend('proposed method','Su et al.[5]','Duan et al[11]','Location','NorthWest');
% a = [1,2,3,4,5,6,7,8];
s = {'0.01%','0.03%','0.05%','0.07%','0.09%','0.11%','0.13%','0.15%'}
grid on;
set(gca,'xtick',x);
...
xlabel('Salt-pepper noise intensity');
ylabel('NC');
legend('proposed method','Su et al.[5]','Duan et al[11]','Location','SouthWest');
% a = [1,2,3,4,5,6,7,8];
s = {'0.01%','0.03%','0.05%','0.07%','0.09%','0.11%','0.13%','0.15%'}
